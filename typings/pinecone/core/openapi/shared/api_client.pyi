...
class ApiClient:
    ...
    def call_api(
        ...
        resource_path: str,
        method: str,
        path_params: dict[str, typing.Any] | None = ...,
        query_params: list[tuple[str, typing.Any]] | None = ...,
        header_params: dict[str, typing.Any] | None = ...,
        body: typing.Any | None = ...,
        post_params: list[tuple[str, typing.Any]] | None = ...,
        files: dict[str, list[io.IOBase]] | None = ...,
        response_type: tuple[typing.Any] | None = ...,
        auth_settings: list[str] | None = ...,
        async_req: bool | None = ...,
        _return_http_data_only: bool | None = ...,
        collection_formats: dict[str, str] | None = ...,
        _preload_content: bool = ...,
        _request_timeout: int | float | tuple | None = ...,
        _host: str | None = ...,
        _check_type: bool | None = ...,
    ...
    def files_parameters(
        self, files: dict[str, list[io.IOBase]] | None = ...,
    ):  # -> list[Any]:
