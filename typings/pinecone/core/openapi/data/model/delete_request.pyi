...
class DeleteRequest(ModelNormal):
    ...
    _nullable = ...
    @cached_property
    def openapi_types(): # -> dict[str, tuple[list[type[str]]] | tuple[type[bool]] | tuple[type[str]] | tuple[dict[type[str], tuple[type[bool], type[date], type[datetime], type[dict[Any, Any]], type[float], type[int], type[list[Any]], type[str], type[None]]]]]:
        """
        This must be a method because a model may have properties that are
        of type self, this must run after the class is loaded
