...
class QueryRequest(ModelNormal):
    ...
    _nullable = ...
    @cached_property
    def openapi_types(): # -> dict[str, tuple[type[int]] | tuple[type[str]] | tuple[dict[type[str], tuple[type[bool], type[date], type[datetime], type[dict[Any, Any]], type[float], type[int], type[list[Any]], type[str], type[None]]]] | tuple[type[bool]] | tuple[list[Any]] | tuple[list[type[float]]] | tuple[Any]]:
        """
        This must be a method because a model may have properties that are
        of type self, this must run after the class is loaded
