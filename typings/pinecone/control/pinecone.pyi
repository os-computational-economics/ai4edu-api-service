...
class Pinecone:
    ...
    def create_index(self, name: str, dimension: int, spec: Union[Dict, ServerlessSpec, PodSpec], metric: Optional[str] = ..., timeout: Optional[int] = ..., deletion_protection: Optional[Literal["enabled", "disabled"]] = ...): # -> None:
    ...
    def configure_index(self, name: str, replicas: Optional[int] = ..., pod_type: Optional[str] = ..., deletion_protection: Optional[Literal["enabled", "disabled"]] = ...): # -> None:
