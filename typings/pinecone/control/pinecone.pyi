...
class Pinecone:
    def __init__(
        ...
        index_api: ManageIndexesApi | None = ...,
        **kwargs,
    ) -> None:
        ...
        pc = Pinecone(api_key="YOUR_API_KEY", proxy_url="https://your-proxy.com")
    ...
    def create_index(
        ...
        name: str,
        dimension: int,
        spec: dict[str, Any] | ServerlessSpec | PodSpec,
        metric: str | None = ...,
        timeout: int | None = ...,
        deletion_protection: Literal["enabled", "disabled"] | None = ...,
    ) -> None:
