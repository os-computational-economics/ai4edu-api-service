...
class Index:
    ...
    def update(
        ...
        set_metadata: dict[
            str, str | float | int | bool | list[int] | list[float] | list[str]
        ]
        | None = ...,
        namespace: str | None = ...,
        sparse_values: SparseValues | dict[str, list[float] | list[int]] | None = ...,
        **kwargs,
    ) -> dict[str, Any]:
        ...
        Examples:
            ...
            >>> index.update(
            ...     id="id1", set_metadata={"key": "value"}, namespace="my_namespace"
            ... )
    ...
    def list_paginated(
        ...
        **kwargs,
        ...
        Examples:
            ...
            ...     prefix="99", limit=5, namespace="my_namespace"
            ... )
