...
endpoint_access_map: AccessMap = {
    ...
    "/agents/agent/{agent_id}": {"student": True, "teacher": True, "system_admin": True},
    ...
    "/threads/get_thread_list": {"student": True, "teacher": True, "system_admin": True},
    ...
    # workspace endpoints
    "/workspace/create_workspace": {"student": False, "teacher": False, "system_admin": True},
    "/workspace/set_workspace_status": {
        "student": False,
        "teacher": True,
        "system_admin": True,
    },
    "/workspace/add_users_via_csv": {"student": False, "teacher": True, "system_admin": True},
    "/workspace/add_users_json": {"student": False, "teacher": True, "system_admin": True},
    ...
    "/test_query/clear_history": {"student": True, "teacher": True, "system_admin": True},
    "/upload_file": {"student": True, "teacher": True, "system_admin": True},
    "/get_presigned_url_for_file": {"student": True, "teacher": True, "system_admin": True},
